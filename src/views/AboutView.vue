<template>
  <div class="about-container" @wheel="handleWheel">
    <!-- Theme Toggle -->
    <ThemeToggle />
    
    <AboutSidebar ref="sidebarRef" :class="{ 
...
import AboutSidebar from '@/components/about/AboutSidebar.vue'
import HomeNavigation from '@/components/home/HomeNavigation.vue'
import ThemeToggle from '@/components/ThemeToggle.vue'

const router = useRouter()
const sidebarRef = ref<InstanceType<typeof AboutSidebar> | null>(null)
